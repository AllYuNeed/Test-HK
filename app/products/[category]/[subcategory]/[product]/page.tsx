...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const product = getProductBySlug(params.category, params.subcategory, params.product);
          ...
          <div className="mt-10 grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="relative">
              <div className="glass border border-[rgba(255,255,255,0.07)] rounded-sm overflow-hidden">
                <div
                  className="aspect-square img-placeholder flex items-center justify-center relative"
                  style={{ minHeight: "380px" }}
                >
                  <div className="absolute inset-0 grid-pattern opacity-40" />
                  <div className="relative z-10 text-center p-10">
                    <div
                      className="text-8xl text-[#1e6bff] opacity-15 mb-4"
                      style={{ fontFamily: "Rajdhani, sans-serif", fontWeight: 700 }}
                    >
                      {product.productName.substring(0, 3).toUpperCase()}
                    </div>
                    <div className="text-steel-400 text-sm" style={{ fontFamily: "Share Tech Mono, monospace" }}>
      ...
      <section className="py-16 bg-charcoal-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              <h2
                className="text-white text-xl mb-6 pb-4 border-b border-[rgba(255,255,255,0.07)]"
                ...
                {Object.entries(product.specs).map(([key, val], i) => (
                  <div
                    ...
                    className={`flex items-center justify-between px-5 py-3 ${
                      i % 2 === 0 ? "bg-[rgba(255,255,255,0.02)]" : "bg-transparent"
                    } hover:bg-[rgba(30,107,255,0.04)] transition-colors`}
                  >
                    <span
            ...
            <div>
              ...
              <div className="space-y-3">
                {product.applications.map((app, i) => (
                  <div
                    key={app}
                    className="flex items-center gap-4 glass border border-[rgba(255,255,255,0.05)] rounded-sm px-5 py-4 hover:border-[rgba(30,107,255,0.2)] transition-colors"
                  >
                    <div
                      className="w-6 h-6 rounded-sm bg-[rgba(30,107,255,0.1)] border border-[rgba(30,107,255,0.2)] flex items-center justify-center text-[10px] text-[#1e6bff] shrink-0"
                      style={{ fontFamily: "Share Tech Mono, monospace" }}
                    >
